      ...
      <div class="container-fluid">
        <nav class="navbar">
          ...
          <div class="header-left flex-grow-1 d-none d-md-block">
            <div class="main-search px-3 flex-fill fs-3">
                ...
                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                  <div class="card border-0 w240">
                    ...
                    <div class="list-group m-2 mb-3">
                      <a class="list-group-item list-group-item-action border-0" href="{{route('account.profile')}}"><i class="w30 fa fa-user"></i>My Profile</a>
                      <a class="list-group-item list-group-item-action border-0" href="{{route('account.setting')}}"><i class="w30 fa fa-gear"></i>Settings</a>
                    </div>
                    <a href="{{route('logout.operation')}}" class="btn bg-secondary text-light text-uppercase rounded-0">Sign out</a>
                  </div>
                </div>
              </div>
            </li>
