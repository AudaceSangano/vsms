    ...
    <div class="container-fluid">
      ...
      <div class="main-menu flex-grow-1">
        ...
        <ul class="menu-list">
          ...
          <li class="collapsed">
            <a class="m-link {{ Route::currentRouteName() == 'report.driver.list'?'active':'' }} {{ Route::currentRouteName() == 'report.employee.list'?'active':'' }} {{ Route::currentRouteName() == 'shift.day.list'?'active':'' }} {{ Route::currentRouteName() == 'shift.night.list'?'active':'' }}" data-bs-toggle="collapse" data-bs-target="#menu-Report" href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" class="bi bi-person-bounding-box" viewBox="0 0 16 16">
                    <path d="M1.5 1a.5.5 0 0 0-.5.5v3a.5.5 0 0 1-1 0v-3A1.5 1.5 0 0 1 1.5 0h3a.5.5 0 0 1 0 1zM11 .5a.5.5 0 0 1 .5-.5h3A1.5 1.5 0 0 1 16 1.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 1-.5-.5M.5 11a.5.5 0 0 1 .5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 1 0 1h-3A1.5 1.5 0 0 1 0 14.5v-3a.5.5 0 0 1 .5-.5m15 0a.5.5 0 0 1 .5.5v3a1.5 1.5 0 0 1-1.5 1.5h-3a.5.5 0 0 1 0-1h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 1 .5-.5"/>
                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                  </svg>
            ...
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse {{ Route::currentRouteName() == 'report.driver.list'?'show':'' }} {{ Route::currentRouteName() == 'report.employee.list'?'show':'' }} {{ Route::currentRouteName() == 'shift.day.list'?'show':'' }} {{ Route::currentRouteName() == 'shift.night.list'?'show':'' }}" id="menu-Report">
              <li><a class="ms-link {{ Route::currentRouteName() == 'report.driver.list'?'active':'' }}" href="{{route('report.driver.list')}}">Driver List</a></li>
              <li><a class="ms-link {{ Route::currentRouteName() == 'report.employee.list'?'active':'' }}" href="{{route('report.employee.list')}}">Employee List</a></li>
              <li><a class="ms-link {{ Route::currentRouteName() == 'shift.day.list'?'active':'' }}" href="{{route('shift.day.list')}}">Day Shift</a></li>
              <li><a class="ms-link {{ Route::currentRouteName() == 'shift.night.list'?'active':'' }}" href="{{route('shift.night.list')}}">Night Shift</a></li>
            </ul>
          </li>
          <li class="collapsed">
